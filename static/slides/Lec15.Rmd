...
.footnote[Generally for a Ridge (or Lasso) model it is important to scale the features before fitting - in this case this is not necessary as $x_1,\ldots,x4$ all have mean of ~0 and std dev of ~1 ]
